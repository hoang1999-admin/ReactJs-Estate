...
class IndexRole extends Component {
    constructor(props) {
        ...
        this.trashrole = this.trashrole.bind(this);
    ...
    editrole(id) {
        this.props.history.push(`/update-role/index=${id}`);
    }
    componentDidMount() {
    ...
    trashrole() {
        this.props.history.push('/trash-role');
    }
    renderroles = () => {
            ...
            return (
                <tr role="row" class="odd" key={key}>
                    ...
                    <td class="text-center">
                        ...
                        <a class="btn btn-info btn-sm" onClick={() => this.editrole(role.id)} href="javascript:void(0)" role="button">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a class="btn btn-danger btn-sm" onClick={() => this.deleterole(role.id)} href="javascript:void(0)" role="button">
                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <strong class="text-danger">DANH SÁCH VAI TRÒ</strong>
                                        </h3>

                                        <div class="card-tools" style={{ float: `right` }}>
                                            <a class="btn btn-sm btn-success" onClick={this.addrole} href="javascript:void(0)"><i class="fas fa-plus"></i> Thêm</a>
                                            <a class="btn btn-sm btn-danger" onClick={this.trashrole} href="javascript:void(0)"><i class="fas fa-trash"></i> Thùng Rác</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-bordered dataTable no-footer" id="myTable">
                                            <thead>
                                                <tr role="row">
                                                    <th style={{ width: `500px` }} class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Tên loại role: activate to sort column ascending">Tên vai trò</th>
