...
class Updateuserrole extends Component {
    ...
    componentDidMount() {
        this.userroleService.getUserRoleById(this.state.id).then((res) => {
    ...
    saveuserrole = (e) => {
        ...
        if (userrole == null || this.state.id == '') {
            alert('Lưu thất bại');
        } else {

            this.userroleService.updateUserRole(userrole, this.state.id).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH CẬP NHẬT VAI TRÒ VÀ THÀNH VIÊN</strong>
                                            </h3>
