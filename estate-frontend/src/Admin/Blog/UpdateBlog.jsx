...
class UpdateBlog extends Component {
    ...
    componentDidMount() {
        this.BlogService.getBlogById(this.state.id).then((res) => {
            let Blogdata = res.data;
            this.setState({
                productidLong: Blogdata.productidLong,
                categoryidLong: Blogdata.categoryidLong,
                titleString: Blogdata.titleString,
                descriptionString: Blogdata.descriptionString,
                slugString: Blogdata.slugString,
                metakeyString: Blogdata.metakeyString,
                metadescString: Blogdata.metadescString,
                priceDouble: Blogdata.priceDouble,
               
                positionString: Blogdata.positionString,
              
                imageString: Blogdata.imageString,
                areaString: Blogdata.areaString,
                addressString: Blogdata.addressString,
                phoneString: Blogdata.phoneString,
                customerString: Blogdata.customerString,
    ...
    saveBlog = (e) => {
        ...
        if (this.validateForm()) {
            ...
            if (Blog == null || this.state.id == '') {
                alert('Lưu thất bại');
            } else {
                this.BlogService.updateBlog(Blog, this.state.id).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH CẬP NHẬT BLOG</strong>
                                            </h3>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="img">Hình ảnh
                                                            <img style={{ marginLeft: `300px` }} title={`/resources/images/posts/${this.state.imageString}`} src={`/resources/images/posts/${this.state.imageString}`} width="100px" height="100px" />
                                                        </label>
