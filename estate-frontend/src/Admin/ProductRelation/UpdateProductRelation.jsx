...
class UpdateProductRelation extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        this.productrelationService.getProductRelationById(this.state.id).then((res) => {
            let productrelationdata = res.data;
            this.setState({
              
           
                productidLong: productrelationdata.productidLong,
                productrelationidLong:productrelationdata.productrelationidLong,
    ...
    saveproductrelation = (e) => {
        ...
        if (productrelation == null || this.state.id == '') {
            alert('Lưu thất bại');
        } else {
            this.productrelationService.updateProductRelation(productrelation, this.state.id).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH CẬP NHẬT SẢN PHẨM LIÊN QUAN</strong>
                                            </h3>
...
export default UpdateProductRelation
