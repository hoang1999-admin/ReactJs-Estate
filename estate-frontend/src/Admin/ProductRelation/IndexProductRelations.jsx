...
class IndexProductRelations extends Component {
    constructor(props) {
        super(props)
        ...
        this.addproductrelation = this.addproductrelation.bind(this);
        this.editproductrelation = this.editproductrelation.bind(this);
        this.trashproductrelation = this.trashproductrelation.bind(this);
    ...
    addproductrelation() {
        this.props.history.push('/add-productrelation');
    }
    trashproductrelation() {
        this.props.history.push('/trash-productrelation');
    }
            ...
            return (
                <tr role="row" class="odd" key={key}>
                    ...
                    <td class="text-center">
                        {
                            productrelation.statusInteger != 2
                                ?
                        ...
                        <a class="btn btn-info btn-sm" onClick={() => this.editproductrelation(productrelation.idLong)} href="javascript:void(0)" role="button">
                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <strong class="text-danger">DANH SÁCH SẢN PHẨM LIÊN QUAN</strong>
                                        </h3>

                                        <div class="card-tools" style={{ float: `right` }}>
                                            <a class="btn btn-sm btn-success" onClick={this.addproductrelation} href="javascript:void(0)"><i class="fas fa-plus"></i> Thêm</a>
                                            <a class="btn btn-sm btn-danger" onClick={this.trashproductrelation} href="javascript:void(0)"><i class="fas fa-trash"></i> Thùng Rác</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
...
export default IndexProductRelations