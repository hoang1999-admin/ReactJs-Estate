...
class TrashPost extends Component {
    constructor(props) {
        ...
        this.retrashpost = this.retrashpost.bind(this);
        ...
        return this.state.posts.map((post, key) => {
            return (
                <tr role="row" class="odd" key={key}>
                    <td class="sorting_1">
                        <img src={`/resources/images/items/${post.imageString}`} class="img-fluid" alt="hinh" />
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" onClick={() => this.retrashpost(post.idLong)} href="javascript:void(0)" role="button">
                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <strong class="text-danger">THÙNG RÁC CỦA TIN TỨC</strong>
                                        </h3>
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="myTable">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: `500px` }} class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Tên loại sản phẩm: activate to sort column ascending">Tên loại tin tức</th>
