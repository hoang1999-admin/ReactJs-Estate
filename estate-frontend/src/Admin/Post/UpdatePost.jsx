...
class UpdatePost extends Component {
    ...
    componentDidMount() {
        this.postService.getPostById(this.state.id).then((res) => {
            let postdata = res.data;
            this.setState({
              
                categoryidLong: postdata.categoryidLong,
                titleString: postdata.titleString,
                descriptionString: postdata.descriptionString,
                slugString: postdata.slugString,
                description1String: postdata.description1String,
                description2String: postdata.description2String,
                description3String: postdata.description3String,
                imageString: postdata.imageString,
                image1String: postdata.image1String,
                image2String: postdata.image2String,
                image3String: postdata.image3String,
    ...
    savepost = (e) => {
        ...
        if (this.validateForm()) {
            ...
            if (post == null || this.state.id == '') {
                alert('Lưu thất bại');
            } else {
                this.postService.updatePost(post, this.state.id).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH CẬP NHẬT TIN TỨC</strong>
                                            </h3>
