...
class TrashEmail extends Component {
    constructor(props) {
        super(props)
        this.state = {
            emails: []
        ...
        this.retrashemail = this.retrashemail.bind(this);
        ...
        return this.state.emails.map((email, key) => {
            return (
                <tr role="row" class="odd" key={key}>
                    ...
                    <td>
                        <a href={`/index=${email.idLong}`}>{email.emailString}</a>
                    </td>

                    <td class="text-center">
                        <a class="btn btn-info btn-sm" onClick={() => this.retrashemail(email.idLong)} href="javascript:void(0)" role="button">
                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <strong class="text-danger">THÙNG RÁC CỦA EMAIL</strong>
                                        </h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="myTable">
                                            <thead>
                                                <tr role="row">
                                                     <th style={{ width: `500px` }} class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Tên email: activate to sort column ascending">Tên email</th>
