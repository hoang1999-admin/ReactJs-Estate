...
class UpdateContact extends Component {
    ...
    componentDidMount() {
        this.contactService.getContactById(this.state.id).then((res) => {
            let contactdata = res.data;
            this.setState({

                fullnameString: contactdata.fullnameString,
                emailString: contactdata.emailString,
                phoneString: contactdata.phoneString,
    ...
    savecontact = (e) => {
        ...
        if (contact == '' || this.state.id == '') {
            alert('Lưu thất bại');
        } else {

            this.contactService.updateContact(contact, this.state.id).then(res => {
