...
class UpdateCategory extends Component {
    ...
    componentDidMount() {
        this.categoryService.getCategoryById(this.state.id).then((res) => {
            let categorydata = res.data;
            this.setState({

                titleString: categorydata.titleString,

                slugString: categorydata.slugString,
                orderLong: categorydata.orderLong,
                ...
                container1Boolean: categorydata.container1Boolean,
                container2Boolean: categorydata.container2Boolean,
                servicecontainerBoolean: categorydata.servicecontainerBoolean,
                requestcontainerBoolean: categorydata.requestcontainerBoolean,
                itemcontainerBoolean: categorydata.itemcontainerBoolean,
                regioncontainerBoolean: categorydata.regioncontainerBoolean,
    ...
    saveCategory = (e) => {
        ...
        if(category==''||this.state.id=='')
        {
            alert('Lưu thất bại');
        }else
        {
         
            this.categoryService.updateCategory(category, this.state.id).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH CẬP NHẬT LOẠI SẢN PHẨM</strong>
                                            </h3>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value={this.state.orderLong} onChange={this.changeOrderHandler} type="number" class="form-control" name="orderString" placeholder=" 1" />
                                                    </div>
