...
class CreatePhoto extends Component {
    ...
    savephoto = (e) => {
        ...
        if (photo == '') {
            ...
            this.photoService.createPhoto(photo).then(res => {
                                ...
                                <section class="content">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong class="text-danger">DANH SÁCH THÊM HÌNH ẢNH</strong>
                                            </h3>
                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value={this.state.typeInteger} onChange={this.changeTypeHandler} type="number" class="form-control" name="typeString" placeholder=" Kiểu hình ảnh" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Mã sản phẩm</label>
                                                        <input value={this.state.productidLong} onChange={this.changeProductidHandler} type="number" class="form-control" name="productidLong" placeholder=" Tên photo" />
                                                    </div>
                                                </div>
                                                <div class="col-6">
