...
class TrashUser extends Component {
    constructor(props) {
        ...
        this.retrashuser = this.retrashuser.bind(this);
    ...
    deleteuser(id) {
        this.userService.deleteUser(id).then(res => {
            this.setState({ users: this.state.users.filter(user => user.idLong !== id) });
            ...
            return (
                <tr user="row" class="odd" key={key}>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" onClick={() => this.retrashuser(user.idLong)} href="javascript:void(0)" user="button">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a class="btn btn-danger btn-sm" onClick={() => this.deleteuser(user.idLong)} href="javascript:void(0)" user="button">
                            <i class="fas fa-trash-alt"></i>
                        </a>
                    </td>
                    <td class="text-center">{user.idLong}</td>
                </tr>
            );
        });
    };
                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <strong class="text-danger">THÙNG RÁC CỦA THÀNH VIÊN</strong>
                                        </h3>
