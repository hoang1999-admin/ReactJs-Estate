...
public class Menu {
	...
	private String linkString;@Column(name = "type")
	private String typeString;@Column(name = "tableid")
	private Integer tableidInteger;@Column(name = "parentid")
	private Integer parentidInteger;@Column(name = "position")
	...
	public Integer getTableidInteger() {
		return tableidInteger;
	}
	public void setTableidInteger(Integer tableidInteger) {
		this.tableidInteger = tableidInteger;
	}
	public Integer getParentidInteger() {
		return parentidInteger;
	}
	public void setParentidInteger(Integer parentidInteger) {
		this.parentidInteger = parentidInteger;
	}
